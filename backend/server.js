...
const API_KEYS = new Map(); // apiKey -> { requests, lastReset }
...
API_KEYS.set(DEFAULT_KEY, { requests: 0, lastReset: Date.now() });
...
app.listen(10000, () => {
    console.log("v8 SaaS production running on port 10000");
});
